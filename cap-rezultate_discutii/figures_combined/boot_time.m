...
legend boxoff;
title({'a)', 'Timpul de initializare inainte de optimizari in reteaua \bf{\it{inel}}'}, "fontsize", 15, "interpreter", "tex");
...
[leg, obj] = legend('Local','Orbit Cloud','DT Cloud', "location", 'northwest');
legend boxoff;
title({'b)', 'Timpul de initializare inainte de optimizari in reteaua \bf{\it{arbore}}'}, "fontsize", 15, "interpreter", "tex");
textobj = findobj(obj, 'type', 'text');
set(textobj, "fontsize", 15);
axis('tight');
set(gca, "fontsize", 15);
...
[leg, obj] = legend('Local','Orbit Cloud','DT Cloud', "location", 'northwest');
legend boxoff;
title({'c)', 'Timpul de initializare inainte de optimizari in reteaua \bf{\it{plasa}}'}, "fontsize", 15, "interpreter", "tex");
textobj = findobj(obj, 'type', 'text');
set(textobj, "fontsize", 15);
axis('tight');
set(gca, "fontsize", 15);
...
[leg, obj] = legend('Local','Orbit Cloud','DT Cloud', "location", 'northwest');
legend boxoff;
title({'d)', 'Timpul de initializare dupa optimizari in reteaua \bf{\it{inel}}'}, "fontsize", 15, "interpreter", "tex");
textobj = findobj(obj, 'type', 'text');
set(textobj, "fontsize", 15);
axis('tight');
set(gca, "fontsize", 15);
...
[leg, obj] = legend('Local','Orbit Cloud','DT Cloud', "location", 'northwest');
legend boxoff;
title({'e)', 'Timpul de initializare dupa optimizari in reteaua \bf{\it{arbore}}'}, "fontsize", 15, "interpreter", "tex");
textobj = findobj(obj, 'type', 'text');
set(textobj, "fontsize", 15);
axis('tight');
set(gca, "fontsize", 15);
...
[leg, obj] = legend('Local','Orbit Cloud','DT Cloud', "location", 'northwest');
legend boxoff;
title({'f)', 'Timpul de initializare dupa optimizari in reteaua \bf{\it{plasa}}'}, "fontsize", 15, "interpreter", "tex");
textobj = findobj(obj, 'type', 'text');
set(textobj, "fontsize", 15);
axis('tight');
set(gca, "fontsize", 15);