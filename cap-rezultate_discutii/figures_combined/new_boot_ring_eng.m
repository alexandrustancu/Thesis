...
set(gca, "fontsize", 18);
xlabel('Total number of simulated objects', "fontsize", 18, "interpreter", "tex");
grid on;
grid minor on;
ylabel('seconds', "fontsize", 18);

[leg, obj] = legend('Local - w/o optimization',
                    'Orbit Cloud - w/o optimization',
                    'DT Cloud - w/o optimization', 
                    'Local - w/ optimization',
                    'Orbit Cloud - w/ optimization',
                    'DT Cloud - w/ optimization',
                    "location", 'northwest');          
legend boxoff;
